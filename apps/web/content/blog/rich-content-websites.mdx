...
The web is a very powerful and versatile medium. It can be as lean or as rich as you want. You can build a lean website with just text and links, or a rich website with interactive, personalized, collaborative, multimedia content.

The trade-off between efficiency and expressiveness is still there.

This is especially important for technical content, where the message is usually complex, and lean text-based websites aren't expressive enough to convey the message.

**I think that most technical content websites are too lean**, making the content harder to understand than it should be.
