...
description: The curse of Markdown
date: 2024-06-30
authors: [pomber]
draft: false
---
...
I believe that **most technical content websites aren't rich enough**. And the main reason is Markdown.

Markdown and all the tooling around it made it very easy to build lean websites, which skewed the lean vs rich trade-off towards lean.
