...
**TL;DR**: Code Hike v1 allows you to turn code walkthroughs into videos using Remotion. You can find the full code in the [Code Hike examples repository](https://github.com/code-hike/examples/tree/main/with-remotion).

For a long time, many people have asked for a way to combine Code Hike and [Remotion](https://www.remotion.dev/) to turn code walkthroughs into videos. So far, because of Code Hike limitations, it wasn't possible to combine them without a lot of hacks.

This changes with Code Hike v1.

The new version focuses on flexibility. You can now use custom react components for everything and pass markdown content in any shape to those components.
...
- in your components, use code hike and remotion to animate transitions
