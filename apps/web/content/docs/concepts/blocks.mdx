...
You can <Pill>decorate</Pill> markdown elements with a special syntax, Code Hike will transform them into object and pass them as props to your components.
