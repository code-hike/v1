...
I'll show you the draft of my talk script, at the end I mention the part of "use the medium: If you are building for the web, use the power of the modern web". where would you think is the best place to put this part in the talk?
...
we start with the content, the thing we want to communicate and then we think about how to present it different content may benefit from different presentation
