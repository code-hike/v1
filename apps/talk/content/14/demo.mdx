...
Next time you're building a content website, instead of defaulting to the same static layout, find something that fits better the content you are trying to communicate.
Use the medium. If you are building for the web, use the power of the modern web.
Maybe it will take more time, but we have the tools and we have the talent.
