...
const positions = {
  ...
  "hidden-l": "bottom-0 left-0 transform -translate-x-full",
  "hidden-br": "bottom-0 right-0 transform translate-x-full translate-y-full",
  "hidden-r": "bottom-0 right-0 transform translate-x-full",
  ...
  return (
    <div className="absolute inset-4">
      <video
        src={video!.url}
        className={cn(
          "rounded absolute w-5/6 transition-all duration-500",
...
function Code({
  ...
  return (
    <Pre
      code={highlighted}
      className={cn(
        "bg-zinc-900 p-2 rounded overflow-hidden whitespace-pre-wrap",
        className,
      )}
